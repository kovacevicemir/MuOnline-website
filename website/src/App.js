      ...
      return (
        <div className="flex space-x-2 text-white font-black text-3xl font-[UnifrakturMaguntia] m-4">
          ...
          <div className="flex flex-col items-center">
            <div
              className="bg-gray-800 whitesmoke glow-effect p-2 w-12 h-12 flex items-center justify-center rounded-md shadow-lg"
    ...
    <div className="App flex justify-center bg-gray-700">
      ...
      >
              ...
              >
                {top100 && (
                  <table className="table-auto w-full border-collapse border border-blue-300 rounded-lg overflow-hidden">
                    ...
                    <tbody>
                      {top100 &&
                        top100.slice(0, 21).map((player, index) => (
                          <tr
                            key={index}
                            className={`${
                ...
                <div className="bg-gray-700 w-fit p-6 rounded-lg shadow-lg mt-1">
                  ...
                  <ul class=" pl-6 space-y-2 text-white text-left list-none">
                    ...
                    <li>
                      ...
                      <span className="glow-effect">Louis Premium Files!</span>
                    </li>
                    <li>
        ...
        <footer className="py-6 bg-gray-900 text-center text-gray-400">
          ...
          <div className="p-2">{onlineCount && <pre>{JSON.stringify(onlineCount, null, 2)}</pre>}</div>
        </footer>
      </body>
    </div>
  );
